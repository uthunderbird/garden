...
| **Гейты перед commit, CI, review и merge**         | Перед тем как результат станет общей или боевой версией                                                                      | Делают определённую проверку условием выкатки во внешний мир. Локальный pre-commit hook обычно можно обойти; CI становится настоящим барьером только тогда, когда required checks и правила ветки не позволяют выполнить merge без него. Гейт относится к правилам внешнего мира, и не должен быть завязан на локальные правила.                                                                                                                         |
| **Наблюдаемость, evals и репродьюсеры**            | Во время исполнения и после провала                                                                                          | Логи, traces, сохранённые входы, повторные прогоны и baseline/intervention серии показывают, что агент видел, какие инструменты вызывал и где изменилось поведение. Они поддерживают диагноз и измеряют долю провалов, но сами ничего не блокируют и не доказывают исчезновение ошибки навсегда.                                                                                                                                                         |
